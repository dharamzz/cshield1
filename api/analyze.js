...
// CoinGecko coin detail — uses cgFetch with full rate-limit retry
async function cgMeta(coinId) {
  try {
    return await cgFetch(`https://api.coingecko.com/api/v3/coins/${coinId}?localization=false&tickers=false&market_data=true&community_data=false&developer_data=false`);
  } catch { return null; }
}

// CoinGecko search+detail — uses cgFetch with full rate-limit retry
// NOTE: this makes 2 CoinGecko calls. Use KNOWN_COINS table to avoid this entirely.
async function cgSearchDetail(query) {
  ...
  if (!hit) throw new Error(`"${query}" not found on CoinGecko. Try the contract address directly (e.g. 0x... for EVM tokens).`);
  const detail = await cgFetch(`https://api.coingecko.com/api/v3/coins/${hit.id}?localization=false&tickers=false&market_data=true&community_data=false&developer_data=false`);
  return detail;
}
...
// ─────────────────────────────────────────────────────────────────────────────
// KNOWN COINS TABLE — bypasses ALL CoinGecko API calls for ~200 common coins.
// Each entry maps ticker/name → { cgId, contract, chain } so we can go straight
// to the holder fetch without hitting the CoinGecko rate limit.
//
// contract = EVM contract address on the primary chain (null for native coins)
// chain    = Moralis chain ID (null for native coins handled by dedicated fetchers)
// cgId     = CoinGecko coin ID (used only to fetch price/image metadata)
// ─────────────────────────────────────────────────────────────────────────────
const KNOWN_COINS = {
  // ── Native coins (no contract — go to dedicated fetcher) ───────────────────
  "bitcoin":       { cgId:"bitcoin",           contract:null, chain:null },
  "btc":           { cgId:"bitcoin",           contract:null, chain:null },
  "ethereum":      { cgId:"ethereum",          contract:null, chain:null },
  "eth":           { cgId:"ethereum",          contract:null, chain:null },
  "ether":         { cgId:"ethereum",          contract:null, chain:null },

  // ── ERC-20 on Ethereum ─────────────────────────────────────────────────────
  "usdt":          { cgId:"tether",            contract:"0xdac17f958d2ee523a2206206994597c13d831ec7", chain:"eth" },
  "tether":        { cgId:"tether",            contract:"0xdac17f958d2ee523a2206206994597c13d831ec7", chain:"eth" },
  "usdc":          { cgId:"usd-coin",          contract:"0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48", chain:"eth" },
  "usd coin":      { cgId:"usd-coin",          contract:"0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48", chain:"eth" },
  "dai":           { cgId:"dai",               contract:"0x6b175474e89094c44da98b954eedeac495271d0f", chain:"eth" },
  "link":          { cgId:"chainlink",         contract:"0x514910771af9ca656af840dff83e8264ecf986ca", chain:"eth" },
  "chainlink":     { cgId:"chainlink",         contract:"0x514910771af9ca656af840dff83e8264ecf986ca", chain:"eth" },
  "uni":           { cgId:"uniswap",           contract:"0x1f9840a85d5af5bf1d1762f925bdaddc4201f984", chain:"eth" },
  "uniswap":       { cgId:"uniswap",           contract:"0x1f9840a85d5af5bf1d1762f925bdaddc4201f984", chain:"eth" },
  "aave":          { cgId:"aave",              contract:"0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9", chain:"eth" },
  "mkr":           { cgId:"maker",             contract:"0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2", chain:"eth" },
  "maker":         { cgId:"maker",             contract:"0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2", chain:"eth" },
  "crv":           { cgId:"curve-dao-token",   contract:"0xd533a949740bb3306d119cc777fa900ba034cd52", chain:"eth" },
  "curve":         { cgId:"curve-dao-token",   contract:"0xd533a949740bb3306d119cc777fa900ba034cd52", chain:"eth" },
  "snx":           { cgId:"havven",            contract:"0xc011a73ee8576fb46f5e1c5751ca3b9fe0af2a6f", chain:"eth" },
  "synthetix":     { cgId:"havven",            contract:"0xc011a73ee8576fb46f5e1c5751ca3b9fe0af2a6f", chain:"eth" },
  "comp":          { cgId:"compound-governance-token", contract:"0xc00e94cb662c3520282e6f5717214004a7f26888", chain:"eth" },
  "compound":      { cgId:"compound-governance-token", contract:"0xc00e94cb662c3520282e6f5717214004a7f26888", chain:"eth" },
  "1inch":         { cgId:"1inch",             contract:"0x111111111117dc0aa78b770fa6a738034120c302", chain:"eth" },
  "bat":           { cgId:"basic-attention-token", contract:"0x0d8775f648430679a709e98d2b0cb6250d2887ef", chain:"eth" },
  "basic attention token": { cgId:"basic-attention-token", contract:"0x0d8775f648430679a709e98d2b0cb6250d2887ef", chain:"eth" },
  "ens":           { cgId:"ethereum-name-service", contract:"0xc18360217d8f7ab5e7c516566761ea12ce7f9d72", chain:"eth" },
  "ldo":           { cgId:"lido-dao",          contract:"0x5a98fcbea516cf06857215779fd812ca3bef1b32", chain:"eth" },
  "lido":          { cgId:"lido-dao",          contract:"0x5a98fcbea516cf06857215779fd812ca3bef1b32", chain:"eth" },
  "shib":          { cgId:"shiba-inu",         contract:"0x95ad61b0a150d79219dcf64e1e6cc01f0b64c4ce", chain:"eth" },
  "shiba inu":     { cgId:"shiba-inu",         contract:"0x95ad61b0a150d79219dcf64e1e6cc01f0b64c4ce", chain:"eth" },
  "pepe":          { cgId:"pepe",              contract:"0x6982508145454ce325ddbe47a25d4ec3d2311933", chain:"eth" },
  "floki":         { cgId:"floki",             contract:"0xcf0c122c6b73ff809c693db761e7baebe62b6a2e", chain:"eth" },
  "dydx":          { cgId:"dydx",              contract:"0x92d6c1e31e14520e676a687f0a93788b716beff5", chain:"eth" },
  "grt":           { cgId:"the-graph",         contract:"0xc944e90c64b2c07662a292be6244bdf05cda44a7", chain:"eth" },
  "the graph":     { cgId:"the-graph",         contract:"0xc944e90c64b2c07662a292be6244bdf05cda44a7", chain:"eth" },
  "imx":           { cgId:"immutable-x",       contract:"0xf57e7e7c23978c3caec3c3548e3d615c346e79ff", chain:"eth" },
  "immutable x":   { cgId:"immutable-x",       contract:"0xf57e7e7c23978c3caec3c3548e3d615c346e79ff", chain:"eth" },
  "ape":           { cgId:"apecoin",           contract:"0x4d224452801aced8b2f0aebe155379bb5d594381", chain:"eth" },
  "apecoin":       { cgId:"apecoin",           contract:"0x4d224452801aced8b2f0aebe155379bb5d594381", chain:"eth" },
  "sand":          { cgId:"the-sandbox",       contract:"0x3845badade8e6dff049820680d1f14bd3903a5d0", chain:"eth" },
  "sandbox":       { cgId:"the-sandbox",       contract:"0x3845badade8e6dff049820680d1f14bd3903a5d0", chain:"eth" },
  "mana":          { cgId:"decentraland",      contract:"0x0f5d2fb29fb7d3cfee444a200298f468908cc942", chain:"eth" },
  "decentraland":  { cgId:"decentraland",      contract:"0x0f5d2fb29fb7d3cfee444a200298f468908cc942", chain:"eth" },
  "chz":           { cgId:"chiliz",            contract:"0x3506424f91fd33084466f402d5d97f05f8e3b4af", chain:"eth" },
  "chiliz":        { cgId:"chiliz",            contract:"0x3506424f91fd33084466f402d5d97f05f8e3b4af", chain:"eth" },
  "axs":           { cgId:"axie-infinity",     contract:"0xbb0e17ef65f82ab018d8edd776e8dd940327b28b", chain:"eth" },
  "axie infinity": { cgId:"axie-infinity",     contract:"0xbb0e17ef65f82ab018d8edd776e8dd940327b28b", chain:"eth" },
  "gala":          { cgId:"gala",              contract:"0xd1d2eb1b1e90b638588728b4130137d262c87cae", chain:"eth" },
  "rpl":           { cgId:"rocket-pool",       contract:"0xd33526068d116ce69f19a9ee46f0bd304f21a51f", chain:"eth" },
  "rocket pool":   { cgId:"rocket-pool",       contract:"0xd33526068d116ce69f19a9ee46f0bd304f21a51f", chain:"eth" },
  "blur":          { cgId:"blur",              contract:"0x5283d291dbcf85356a21ba090e6db59121208b44", chain:"eth" },
  "wbtc":          { cgId:"wrapped-bitcoin",   contract:"0x2260fac5e5542a773aa44fbcfedf7c193bc2c599", chain:"eth" },
  "wrapped bitcoin": { cgId:"wrapped-bitcoin", contract:"0x2260fac5e5542a773aa44fbcfedf7c193bc2c599", chain:"eth" },
  "weth":          { cgId:"weth",              contract:"0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2", chain:"eth" },
  "wrapped ether": { cgId:"weth",              contract:"0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2", chain:"eth" },
  "frax":          { cgId:"frax",              contract:"0x853d955acef822db058eb8505911ed77f175b99e", chain:"eth" },
  "steth":         { cgId:"staked-ether",      contract:"0xae7ab96520de3a18e5e111b5eaab095312d7fe84", chain:"eth" },
  "staked ether":  { cgId:"staked-ether",      contract:"0xae7ab96520de3a18e5e111b5eaab095312d7fe84", chain:"eth" },
  "yfi":           { cgId:"yearn-finance",     contract:"0x0bc529c00c6401aef6d220be8c6ea1667f6ad93e", chain:"eth" },
  "yearn finance": { cgId:"yearn-finance",     contract:"0x0bc529c00c6401aef6d220be8c6ea1667f6ad93e", chain:"eth" },
  "bal":           { cgId:"balancer",          contract:"0xba100000625a3754423978a60c9317c58a424e3d", chain:"eth" },
  "balancer":      { cgId:"balancer",          contract:"0xba100000625a3754423978a60c9317c58a424e3d", chain:"eth" },
  "cvx":           { cgId:"convex-finance",    contract:"0x4e3fbd56cd56c3e72c1403e103b45db9da5b9d2b", chain:"eth" },
  "convex":        { cgId:"convex-finance",    contract:"0x4e3fbd56cd56c3e72c1403e103b45db9da5b9d2b", chain:"eth" },
  "sushi":         { cgId:"sushi",             contract:"0x6b3595068778dd592e39a122f4f5a5cf09c90fe2", chain:"eth" },
  "sushiswap":     { cgId:"sushi",             contract:"0x6b3595068778dd592e39a122f4f5a5cf09c90fe2", chain:"eth" },
  "fxs":           { cgId:"frax-share",        contract:"0x3432b6a60d23ca0dfca7761b7ab56459d9c964d0", chain:"eth" },
  "frax share":    { cgId:"frax-share",        contract:"0x3432b6a60d23ca0dfca7761b7ab56459d9c964d0", chain:"eth" },
  "perp":          { cgId:"perpetual-protocol",contract:"0xbc396689893d065f41bc2c6ecbee5e0085233447", chain:"eth" },
  "lqty":          { cgId:"liquity",           contract:"0x6dea81c8171d0ba574754ef6f8b412f2ed88c54d", chain:"eth" },
  "ocean":         { cgId:"ocean-protocol",    contract:"0x967da4048cd07ab37855c090aaf366e4ce1b9f48", chain:"eth" },
  "ocean protocol":{ cgId:"ocean-protocol",    contract:"0x967da4048cd07ab37855c090aaf366e4ce1b9f48", chain:"eth" },
  "band":          { cgId:"band-protocol",     contract:"0xba11d00c5f74255f56a5e366f4f77f5a186d7f55", chain:"eth" },
  "band protocol": { cgId:"band-protocol",     contract:"0xba11d00c5f74255f56a5e366f4f77f5a186d7f55", chain:"eth" },
  "storj":         { cgId:"storj",             contract:"0xb64ef51c888972c908cfacf59b47c1afbc0ab8ac", chain:"eth" },
  "ren":           { cgId:"republic-protocol", contract:"0x408e41876cccdc0f92210600ef50372656052a38", chain:"eth" },
  "tusd":          { cgId:"true-usd",          contract:"0x0000000000085d4780b73119b644ae5ecd22b376", chain:"eth" },
  "true usd":      { cgId:"true-usd",          contract:"0x0000000000085d4780b73119b644ae5ecd22b376", chain:"eth" },
  "gno":           { cgId:"gnosis",            contract:"0x6810e776880c02933d47db1b9fc05908e5386b96", chain:"eth" },
  "gnosis":        { cgId:"gnosis",            contract:"0x6810e776880c02933d47db1b9fc05908e5386b96", chain:"eth" },
  "enj":           { cgId:"enjincoin",         contract:"0xf629cbd94d3791c9250152bd8dfbdf380e2a3b9c", chain:"eth" },
  "enjin":         { cgId:"enjincoin",         contract:"0xf629cbd94d3791c9250152bd8dfbdf380e2a3b9c", chain:"eth" },
  "zrx":           { cgId:"0x",               contract:"0xe41d2489571d322189246dafa5ebde1f4699f498", chain:"eth" },
  "ankr":          { cgId:"ankr",             contract:"0x8290333cef9e6d528dd5618fb97a76f268f3edd4", chain:"eth" },
  "ctsi":          { cgId:"cartesi",           contract:"0x491604c0fdf08347dd1fa4ee062a822a5dd06b5d", chain:"eth" },
  "cartesi":       { cgId:"cartesi",           contract:"0x491604c0fdf08347dd1fa4ee062a822a5dd06b5d", chain:"eth" },
  "celr":          { cgId:"celer-network",     contract:"0x4f9254c83eb525f9fcf346490bbb3ed28a81c667", chain:"eth" },
  "nmr":           { cgId:"numeraire",         contract:"0x1776e1f26f98b1a5df9cd347953a26dd3cb46671", chain:"eth" },
  "numeraire":     { cgId:"numeraire",         contract:"0x1776e1f26f98b1a5df9cd347953a26dd3cb46671", chain:"eth" },
  "gtc":           { cgId:"gitcoin",           contract:"0xde30da39c46104798bb5aa3fe8b9e0e1f348163f", chain:"eth" },
  "gitcoin":       { cgId:"gitcoin",           contract:"0xde30da39c46104798bb5aa3fe8b9e0e1f348163f", chain:"eth" },
  "dpi":           { cgId:"defi-pulse-index",  contract:"0x1494ca1f11d487c2bbe4543e90080aeba4ba3c2b", chain:"eth" },
  "cbeth":         { cgId:"coinbase-wrapped-staked-eth", contract:"0xbe9895146f7af43049ca1c1ae358b0541ea49704", chain:"eth" },

  // ── Multi-chain EVM (Arbitrum, Base, Optimism, Polygon, etc.) ─────────────
  "arb":           { cgId:"arbitrum",          contract:"0x912ce59144191c1204e64559fe8253a0e49e6548", chain:"arbitrum" },
  "arbitrum":      { cgId:"arbitrum",          contract:"0x912ce59144191c1204e64559fe8253a0e49e6548", chain:"arbitrum" },
  "op":            { cgId:"optimism",          contract:"0x4200000000000000000000000000000000000042", chain:"optimism" },
  "optimism":      { cgId:"optimism",          contract:"0x4200000000000000000000000000000000000042", chain:"optimism" },
  "gmx":           { cgId:"gmx",               contract:"0xfc5a1a6eb076a2c7ad06ed22c90d7e710e35ad0a", chain:"arbitrum" },
  "magic":         { cgId:"magic",             contract:"0x539bde0d7dbd336b79148aa742883198bbf60342", chain:"arbitrum" },
  "stg":           { cgId:"stargate-finance",  contract:"0x6694340fc020c5e6b96567843da2df01b2ce1eb6", chain:"arbitrum" },
  "stargate":      { cgId:"stargate-finance",  contract:"0x6694340fc020c5e6b96567843da2df01b2ce1eb6", chain:"arbitrum" },
  "velo":          { cgId:"velodrome-finance", contract:"0x9560e827af36c94d2ac33a39bce1fe78631088db", chain:"optimism" },
  "velodrome":     { cgId:"velodrome-finance", contract:"0x9560e827af36c94d2ac33a39bce1fe78631088db", chain:"optimism" },
  "aero":          { cgId:"aerodrome-finance", contract:"0x940181a94a35a4569e4529a3cdfb74e38fd98631", chain:"base" },
  "aerodrome":     { cgId:"aerodrome-finance", contract:"0x940181a94a35a4569e4529a3cdfb74e38fd98631", chain:"base" },
  "rdnt":          { cgId:"radiant-capital",   contract:"0x3082cc23568ea640225c2467653db90e9250aaa0", chain:"arbitrum" },
  "radiant":       { cgId:"radiant-capital",   contract:"0x3082cc23568ea640225c2467653db90e9250aaa0", chain:"arbitrum" },

  // ── BEP-20 on BSC ─────────────────────────────────────────────────────────
  "cake":          { cgId:"pancakeswap-token", contract:"0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", chain:"bsc" },
  "pancakeswap":   { cgId:"pancakeswap-token", contract:"0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", chain:"bsc" },
  "xvs":           { cgId:"venus",             contract:"0xcf6bb5389c92bdda8a3747ddb454cb7a64626c63", chain:"bsc" },
  "venus":         { cgId:"venus",             contract:"0xcf6bb5389c92bdda8a3747ddb454cb7a64626c63", chain:"bsc" },
  "bake":          { cgId:"bakerytoken",       contract:"0xe02df9e3e622debdd69fb838bb799e3f168902c5", chain:"bsc" },
  "bakeryswap":    { cgId:"bakerytoken",       contract:"0xe02df9e3e622debdd69fb838bb799e3f168902c5", chain:"bsc" },
  "alpaca":        { cgId:"alpaca-finance",    contract:"0x8f0528ce5ef7b51152a59745befdd91d97091d2f", chain:"bsc" },
  "busd":          { cgId:"binance-usd",       contract:"0xe9e7cea3dedca5984780bafc599bd69add087d56", chain:"bsc" },
  // ── Added: user test list coins ────────────────────────────────────────────
  "bnb":           { cgId:"binancecoin",        contract:"0xb8c77482e45f1f44de1745f52c74426c631bdd52", chain:"eth" },
  "binancecoin":   { cgId:"binancecoin",        contract:"0xb8c77482e45f1f44de1745f52c74426c631bdd52", chain:"eth" },
  "wsteth":        { cgId:"wrapped-steth",      contract:"0x7f39c581f595b53c5cb19bd0b3f8da6c935e2ca0", chain:"eth" },
  "wrapped steth": { cgId:"wrapped-steth",      contract:"0x7f39c581f595b53c5cb19bd0b3f8da6c935e2ca0", chain:"eth" },
  "leo":           { cgId:"leo-token",          contract:"0x2af5d2ad76741191d15dfe7bf6ac92d4bd912ca3", chain:"eth" },
  "bitfinex leo":  { cgId:"leo-token",          contract:"0x2af5d2ad76741191d15dfe7bf6ac92d4bd912ca3", chain:"eth" },
  "wbeth":         { cgId:"wrapped-beacon-eth", contract:"0xa2e3356610840701bdf5611a53974510ae27e2e1", chain:"eth" },
  "wrapped beacon eth": { cgId:"wrapped-beacon-eth", contract:"0xa2e3356610840701bdf5611a53974510ae27e2e1", chain:"eth" },
  "aweth":         { cgId:"aave-weth",          contract:"0x4d5f47fa6a74757f35c14fd3a6ef8e3c9bc514e8", chain:"eth" },
  "cbbtc":         { cgId:"coinbase-wrapped-btc", contract:"0xcbb7c0000ab88b473b1f5afd9ef808440eed33bf", chain:"eth" },
  "coinbase wrapped btc": { cgId:"coinbase-wrapped-btc", contract:"0xcbb7c0000ab88b473b1f5afd9ef808440eed33bf", chain:"eth" },
  "weeth":         { cgId:"wrapped-eeth",       contract:"0xcd5fe23c85820f7b72d0926fc9b05b43e359b7ee", chain:"eth" },
  "wrapped eeth":  { cgId:"wrapped-eeth",       contract:"0xcd5fe23c85820f7b72d0926fc9b05b43e359b7ee", chain:"eth" },
  "usde":          { cgId:"ethena-usde",        contract:"0x4c9edd5852cd905f086c759e8383e09bff1e68b3", chain:"eth" },
  "ethena usde":   { cgId:"ethena-usde",        contract:"0x4c9edd5852cd905f086c759e8383e09bff1e68b3", chain:"eth" },
  "pyusd":         { cgId:"paypal-usd",         contract:"0x6c3ea9036406852006290770bedfcaba0e23a0e8", chain:"eth" },
  "paypal usd":    { cgId:"paypal-usd",         contract:"0x6c3ea9036406852006290770bedfcaba0e23a0e8", chain:"eth" },
  "usds":          { cgId:"usds",               contract:"0xdc035d45d973e3ec169d2276ddab16f1e407384f", chain:"eth" },
  "sky":           { cgId:"sky",                contract:"0x56072c95faa701256059aa122697b133aded9279", chain:"eth" },
  "cro":           { cgId:"crypto-com-chain",   contract:"0xa0b73e1ff0b80914ab6fe0444e65848c4c34450b", chain:"eth" },
  "cronos":        { cgId:"crypto-com-chain",   contract:"0xa0b73e1ff0b80914ab6fe0444e65848c4c34450b", chain:"eth" },
  "susde":         { cgId:"ethena-staked-usde", contract:"0x9d39a5de30e57443bff2a8307a4256c8797a3497", chain:"eth" },
  "staked usde":   { cgId:"ethena-staked-usde", contract:"0x9d39a5de30e57443bff2a8307a4256c8797a3497", chain:"eth" },
  "xaut":          { cgId:"tether-gold",        contract:"0x68749665ff8d2d112fa859aa293f07a622782f38", chain:"eth" },
  "tether gold":   { cgId:"tether-gold",        contract:"0x68749665ff8d2d112fa859aa293f07a622782f38", chain:"eth" },
  "paxg":          { cgId:"pax-gold",           contract:"0x45804880de22913dafe09f4980848ece6ecbaf78", chain:"eth" },
  "pax gold":      { cgId:"pax-gold",           contract:"0x45804880de22913dafe09f4980848ece6ecbaf78", chain:"eth" },
  "mnt":           { cgId:"mantle",             contract:"0x3c3a81e81dc49a522a592e7622a7e711c06bf354", chain:"eth" },
  "mantle":        { cgId:"mantle",             contract:"0x3c3a81e81dc49a522a592e7622a7e711c06bf354", chain:"eth" },
  "okb":           { cgId:"okb",                contract:"0x75231f58b43240c9718dd58b4967c5114342a86c", chain:"eth" },
  "rlusd":         { cgId:"ripple-usd",         contract:"0x8292bb45bf1ee4d140127049757c2e0ff06317ed", chain:"eth" },
  "ripple usd":    { cgId:"ripple-usd",         contract:"0x8292bb45bf1ee4d140127049757c2e0ff06317ed", chain:"eth" },
  "bgb":           { cgId:"bitget-token",       contract:"0x19de6b897ed14a376dda0fe53a5420d2ac828a28", chain:"eth" },
  "bitget token":  { cgId:"bitget-token",       contract:"0x19de6b897ed14a376dda0fe53a5420d2ac828a28", chain:"eth" },
  "rseth":         { cgId:"kelp-dao-restaked-eth", contract:"0xa1290d69c65a6fe4df752f95823fae25cb99e5a7", chain:"eth" },
  "ondo":          { cgId:"ondo-finance",       contract:"0xfaba6f8e4a5e8ab82f62fe7c39859fa577269be3", chain:"eth" },
  "qnt":           { cgId:"quant-network",      contract:"0x4a220e6096b25eadb88358cb44068a3248254675", chain:"eth" },
  "quant":         { cgId:"quant-network",      contract:"0x4a220e6096b25eadb88358cb44068a3248254675", chain:"eth" },
  "pol":           { cgId:"matic-network",      contract:"0x455e53cbb86018ac2b8092fdcd39d8444affc3a6", chain:"eth" },
  "polygon":       { cgId:"matic-network",      contract:"0x455e53cbb86018ac2b8092fdcd39d8444affc3a6", chain:"eth" },
  "render":        { cgId:"render-token",       contract:"0x6de037ef9ad2725eb40118bb1702ebb27e4aeb24", chain:"eth" },
  "rndr":          { cgId:"render-token",       contract:"0x6de037ef9ad2725eb40118bb1702ebb27e4aeb24", chain:"eth" },
  "ftm":           { cgId:"fantom",             contract:"0x4e15361fd6b4bb609fa63c81a2be19d873717870", chain:"eth" },
  "fantom":        { cgId:"fantom",             contract:"0x4e15361fd6b4bb609fa63c81a2be19d873717870", chain:"eth" },
  "ena":           { cgId:"ethena",             contract:"0x57e114b691db790c35207b2e685d4a43181e6061", chain:"eth" },
  "ethena":        { cgId:"ethena",             contract:"0x57e114b691db790c35207b2e685d4a43181e6061", chain:"eth" },
  "pendle":        { cgId:"pendle",             contract:"0x808507121b80c02388fad14726482e061b8da827", chain:"eth" },
  "metis":         { cgId:"metis-token",        contract:"0x9e32b13ce7f2e80a01932b42553652e053d6ed8e", chain:"eth" },
  "blast":         { cgId:"blast",              contract:"0x87056f5e8a2126ba72a11f99ca02e3e3bde04ab7", chain:"eth" },
  "wld":           { cgId:"worldcoin-wld",      contract:"0x163f8c2467924be0ae7b5347228cabf260318753", chain:"eth" },
  "worldcoin":     { cgId:"worldcoin-wld",      contract:"0x163f8c2467924be0ae7b5347228cabf260318753", chain:"eth" },
  "jasmy":         { cgId:"jasmycoin",          contract:"0x7420b4b9a0110cdc71fb720908340c03f9bc03ec", chain:"eth" },
  "reth":          { cgId:"rocket-pool-eth",    contract:"0xae78736cd615f374d3085123a210448e74fc6393", chain:"eth" },
  "rocket pool eth": { cgId:"rocket-pool-eth",  contract:"0xae78736cd615f374d3085123a210448e74fc6393", chain:"eth" },
  "woo":           { cgId:"woo-network",        contract:"0x4691937a7508860f876c9c0a2a617e7d9e945d4b", chain:"eth" },
  "woo network":   { cgId:"woo-network",        contract:"0x4691937a7508860f876c9c0a2a617e7d9e945d4b", chain:"eth" },
  "ethfi":         { cgId:"ether-fi",           contract:"0xfe0c30065b384f05761f15d0cc899d4f9f9cc0eb", chain:"eth" },
  "ether.fi":      { cgId:"ether-fi",           contract:"0xfe0c30065b384f05761f15d0cc899d4f9f9cc0eb", chain:"eth" },
  "alt":           { cgId:"altlayer",           contract:"0x8457ca5040ad67fdebbcc8edce889a335bc0fbfb", chain:"eth" },
  "altlayer":      { cgId:"altlayer",           contract:"0x8457ca5040ad67fdebbcc8edce889a335bc0fbfb", chain:"eth" },
  "manta":         { cgId:"manta-network",      contract:"0x95cef13441be50d20ca4558cc0a27b601ac544e5", chain:"eth" },
  "manta network": { cgId:"manta-network",      contract:"0x95cef13441be50d20ca4558cc0a27b601ac544e5", chain:"eth" },
  "pixel":         { cgId:"pixels",             contract:"0x3429d03c6f7521aec737a0bbf2e5ddcef2c3ae31", chain:"eth" },
  "pixels":        { cgId:"pixels",             contract:"0x3429d03c6f7521aec737a0bbf2e5ddcef2c3ae31", chain:"eth" },
  "portal":        { cgId:"portal-gaming",      contract:"0x1bbe973bef3a977fc51cbfe7c67c25c09af2d0d2", chain:"eth" },
  "agix":          { cgId:"singularitynet",     contract:"0x5b7533812759b45c2b44c19e320ba2cd2681b542", chain:"eth" },
  "singularitynet":{ cgId:"singularitynet",     contract:"0x5b7533812759b45c2b44c19e320ba2cd2681b542", chain:"eth" },
  "fet":           { cgId:"fetch-ai",           contract:"0xaea46a60368a7bd060eec7df8cba43b7ef41ad85", chain:"eth" },
  "fetch.ai":      { cgId:"fetch-ai",           contract:"0xaea46a60368a7bd060eec7df8cba43b7ef41ad85", chain:"eth" },
  "trac":          { cgId:"origintrail",        contract:"0xaa7a9ca87d3694b5755f213b5d04094b8d0f0a6f", chain:"eth" },
  "origintrail":   { cgId:"origintrail",        contract:"0xaa7a9ca87d3694b5755f213b5d04094b8d0f0a6f", chain:"eth" },
  "tel":           { cgId:"telcoin",            contract:"0x467bccd9d29f223bce8043b84e8c8b282827790f", chain:"eth" },
  "telcoin":       { cgId:"telcoin",            contract:"0x467bccd9d29f223bce8043b84e8c8b282827790f", chain:"eth" },
  "lpt":           { cgId:"livepeer",           contract:"0x58b6a8a3302369daec383334672404ee733ab239", chain:"eth" },
  "livepeer":      { cgId:"livepeer",           contract:"0x58b6a8a3302369daec383334672404ee733ab239", chain:"eth" },
  "glm":           { cgId:"golem",              contract:"0x7dd9c5cba05e151c895fde1cf355c9a1d5da6429", chain:"eth" },
  "golem":         { cgId:"golem",              contract:"0x7dd9c5cba05e151c895fde1cf355c9a1d5da6429", chain:"eth" },
  "hot":           { cgId:"holotoken",          contract:"0x6c6ee5e31d828de241282b9606c8e98ea48526e2", chain:"eth" },
  "holo":          { cgId:"holotoken",          contract:"0x6c6ee5e31d828de241282b9606c8e98ea48526e2", chain:"eth" },
  "ilv":           { cgId:"illuvium",           contract:"0x767fe9edc9e0df98e07454847909b5e959d7ca0e", chain:"eth" },
  "illuvium":      { cgId:"illuvium",           contract:"0x767fe9edc9e0df98e07454847909b5e959d7ca0e", chain:"eth" },
  "ygg":           { cgId:"yield-guild-games",  contract:"0x25f8087ead173b73d6e8b84329989a8eea16cf73", chain:"eth" },
  "yield guild games": { cgId:"yield-guild-games", contract:"0x25f8087ead173b73d6e8b84329989a8eea16cf73", chain:"eth" },
  "mc":            { cgId:"merit-circle",       contract:"0x949d48eca67b17269629c7194f4b727d4ef9e5d6", chain:"eth" },
  "merit circle":  { cgId:"merit-circle",       contract:"0x949d48eca67b17269629c7194f4b727d4ef9e5d6", chain:"eth" },
  "mog":           { cgId:"mog-coin",           contract:"0xaaeE1A9723aaDB7afA2810263653A34bA2C21C7a", chain:"eth" },
  "mog coin":      { cgId:"mog-coin",           contract:"0xaaeE1A9723aaDB7afA2810263653A34bA2C21C7a", chain:"eth" },
  // ── coins with no clean on-chain EVM presence — skipped CG needed ──────────
  // HTX (exchange token - no ERC20), GT (Gate token - no ERC20),
  // USDG (new), USDY (Ondo's yield token), OKB already added above
  "htx":           { cgId:"huobi-token",        contract:"0x6f259637dcd74c767781e37bc6133cd6a68aa161", chain:"eth" },
  "huobi token":   { cgId:"huobi-token",        contract:"0x6f259637dcd74c767781e37bc6133cd6a68aa161", chain:"eth" },
  "gt":            { cgId:"gatechain-token",    contract:"0xe66747a101bff2dba3697199dcce5b743b454759", chain:"eth" },
  "gatechain":     { cgId:"gatechain-token",    contract:"0xe66747a101bff2dba3697199dcce5b743b454759", chain:"eth" },
  "usdg":          { cgId:"global-dollar",      contract:"0xf8b1378579659d8f7ee5f3c929c2f3e332e41fd4", chain:"eth" },
  "usdy":          { cgId:"ondo-us-dollar-yield",contract:"0x96f6ef951840721adbf46ac996b59e0235cb985c", chain:"eth" },
  "suds":          { cgId:"savings-usds",       contract:"0xa3931d71877c0e7a3148cb7eb4463524fec27fbd", chain:"eth" },
  "savings usds":  { cgId:"savings-usds",       contract:"0xa3931d71877c0e7a3148cb7eb4463524fec27fbd", chain:"eth" },
};

async function resolveByName(query) {
  // ── Fast path: check known coins table first (zero CoinGecko calls) ────────
  const ql = query.trim().toLowerCase();
  const known = KNOWN_COINS[ql];
  if (known) {
    // Fetch metadata (price, image) gracefully — failure is non-fatal
    const cgData = await cgMeta(known.cgId);
    const meta = {
    ...
    // Native coins — go straight to dedicated fetcher
    if (!known.contract) {
      const id = known.cgId;
    ...
    // EVM token — go straight to holder fetch
    return fetchEVMTokenHolders(known.contract, known.chain, meta);
  }

  // ── Slow path: unknown coin — ask CoinGecko (2 API calls) ─────────────────
  ...
  // EVM token — find the best platform key we support
  ...
  throw new Error(
    `"${detail.name}" (${detail.symbol?.toUpperCase()}) lives on ${chainStr}, which isn't supported yet. ` +
    "Supported: Bitcoin, Ethereum, BNB Chain, Solana, XRP Ledger, Dogecoin, Cardano, " +
    "Tron, Avalanche, Polygon, Polkadot, Cosmos, NEAR, Aptos, Sui, Hyperliquid, " +
    "and any EVM token on Arbitrum, Base, Optimism, Fantom, Cronos, Linea, zkSync, and 40+ more chains (requires MORALIS_API_KEY)."
  );
}
...
// CoinGecko-safe fetch: retries on 429 with exponential backoff (up to 3 attempts)
    ...
    try {
      ...
      if (r.status === 429) {
        if (attempt === delays.length)
          throw new Error(`HTTP 429 from api.coingecko.com — CoinGecko rate limit reached. Try again in 60 seconds, or paste the contract address directly to skip CoinGecko entirely.`);
        const wait = delays[attempt];
        console.warn(`[CoinGecko] 429 rate-limited, waiting ${wait}ms before retry ${attempt + 1}...`);
      ...
      if (e.message.includes("429") && attempt < delays.length) continue;
      throw e;
    }
  }
}
