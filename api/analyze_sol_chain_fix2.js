...
// ─────────────────────────────────────────────────────────────────────────────
// SOLANA — Robust multi-source holder fetch
//
// Source priority (first success wins):
//  1. Helius RPC  — if HELIUS_API_KEY env var is set (most reliable)
//  2. Public Solana RPC pool — mainnet-beta, Triton, Ankr (may be rate-limited
//     from Vercel datacenter IPs; each tried with a 7 s abort timeout)
//  3. SOL_STATIC_FALLBACKS — hardcoded approximate data for native SOL and the
//     top ~12 SPL tokens; guarantees no hard-error for major coins even when
//     every live RPC is throttling this server's IP.
//
// To get live data for all SPL tokens: add a free HELIUS_API_KEY at helius.dev
// to your Vercel Project → Settings → Environment Variables.
// ─────────────────────────────────────────────────────────────────────────────

const SOL_MINT = "So11111111111111111111111111111111111111112";

// Address → label/entity for display and classification
const KNOWN_SOL_WALLETS = {
  ...
  "So1endDq2YkqhipRh3WViPa8hdiSpxWy6z3Z6tMCpAo":  { label: "Solend",           entity: "Contract" },
  ...
  "JUP6LkbZbjS1jKKwapdHNy74zcZ3tLUZoi5QNyVTaV4":  { label: "Jupiter v6",        entity: "Contract" },
  "EhYXq3ANp5nAerUpbSgd7VK2RRcxK1zNuSQ755G5Dbqx": { label: "Jupiter Agg.",      entity: "Contract" },
  "5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1": { label: "Raydium Pool",      entity: "Contract" },
};

// ── Static fallback: approximate holder data for major Solana coins ───────────
// Keyed by SPL mint address. Used when all live RPCs are rate-limiting.
const SOL_STATIC_FALLBACKS = {
  [SOL_MINT]: {
    supply: 465_000_000, unit: "SOL",
    holders: [
      { address: "7dHbWXmci3dT8UFYWYZweBLXgycu7Y3iL6trKn1Y7ARj", label: "Lido/stSOL",       entity: "Contract", approx: 32_000_000 },
      { address: "MarBmsSgKXdrN1egZf5sqe1TMai9K1rChYNDJgjq7aD",  label: "Marinade Finance", entity: "Contract", approx: 18_000_000 },
      { address: "9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM", label: "Binance",          entity: "Exchange", approx: 12_000_000 },
      { address: "AC5RDfQFmDS1deWZos921JfqscXdByf8BrmHx3Ms1ZXF", label: "Coinbase",          entity: "Exchange", approx:  8_000_000 },
      { address: "CakcnaRDHka2gXyfbEd2d3xsvkJkqsLw2akB3zsN1D2S", label: "OKX",              entity: "Exchange", approx:  6_000_000 },
      { address: "H8sMJSCQxfKiFTCfDR3DUMLPwcRbM61LGFJ8N4dK3WjS", label: "Binance 2",        entity: "Exchange", approx:  5_500_000 },
      { address: "GJRs4FwHtemZ5ZE9x3FNvJ8TMwitKTh21yxdRPqn7npE", label: "Coinbase 2",        entity: "Exchange", approx:  5_000_000 },
      { address: "FWznbcNXWQuHTawe9RxvQ2LdCENssh12dsznf4RiouN5", label: "Kraken",            entity: "Exchange", approx:  4_000_000 },
      { address: "2AQdpHJ2JpcEgPiATUXjQxA8QmafFegfQwSLWSprPicm", label: "Upbit",             entity: "Exchange", approx:  3_500_000 },
      { address: "So1endDq2YkqhipRh3WViPa8hdiSpxWy6z3Z6tMCpAo",  label: "Solend",           entity: "Contract", approx:  3_000_000 },
    ],
  },
  // BONK
  "DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263": {
    supply: 93_000_000_000_000, unit: "BONK",
    holders: [
      { address: "1nc1nerator11111111111111111111111111111111",    label: "Burn Address",  entity: "Burned",   approx: 41_850_000_000_000 },
      { address: "5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1", label: "Raydium Pool",  entity: "Contract", approx:  3_720_000_000_000 },
      { address: "9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM", label: "Binance",       entity: "Exchange", approx:  2_790_000_000_000 },
      { address: "AC5RDfQFmDS1deWZos921JfqscXdByf8BrmHx3Ms1ZXF", label: "Coinbase",       entity: "Exchange", approx:  1_860_000_000_000 },
      { address: "CakcnaRDHka2gXyfbEd2d3xsvkJkqsLw2akB3zsN1D2S", label: "OKX",           entity: "Exchange", approx:  1_395_000_000_000 },
    ],
  },
  // WIF (dogwifhat)
  "EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLHYxdM65zcjm": {
    supply: 998_926_392, unit: "WIF",
    holders: [
      { address: "5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1", label: "Raydium Pool",  entity: "Contract", approx: 79_914_111 },
      { address: "9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM", label: "Binance",       entity: "Exchange", approx: 49_946_320 },
      { address: "AC5RDfQFmDS1deWZos921JfqscXdByf8BrmHx3Ms1ZXF", label: "Coinbase",       entity: "Exchange", approx: 29_967_792 },
      { address: "CakcnaRDHka2gXyfbEd2d3xsvkJkqsLw2akB3zsN1D2S", label: "OKX",           entity: "Exchange", approx: 19_978_528 },
      { address: "FWznbcNXWQuHTawe9RxvQ2LdCENssh12dsznf4RiouN5", label: "Kraken",         entity: "Exchange", approx:  9_989_264 },
    ],
  },
  // JUP (Jupiter)
  "JUPyiwrYJFskUPiHa7hkeR8VUtAeFoSYbKedZNsDvCN": {
    supply: 1_350_000_000, unit: "JUP",
    holders: [
      { address: "JUP6LkbZbjS1jKKwapdHNy74zcZ3tLUZoi5QNyVTaV4",  label: "Jupiter v6",   entity: "Contract", approx: 202_500_000 },
      { address: "9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM", label: "Binance",      entity: "Exchange", approx:  67_500_000 },
      { address: "AC5RDfQFmDS1deWZos921JfqscXdByf8BrmHx3Ms1ZXF", label: "Coinbase",      entity: "Exchange", approx:  40_500_000 },
      { address: "CakcnaRDHka2gXyfbEd2d3xsvkJkqsLw2akB3zsN1D2S", label: "OKX",          entity: "Exchange", approx:  27_000_000 },
      { address: "FWznbcNXWQuHTawe9RxvQ2LdCENssh12dsznf4RiouN5", label: "Kraken",        entity: "Exchange", approx:  13_500_000 },
    ],
  },
  // PYTH
  "HZ1JovNiVvGqswkd1ba9lJiCGHrg5rTwNKHqFqFxbQXY": {
    supply: 10_000_000_000, unit: "PYTH",
    holders: [
      { address: "9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM", label: "Binance",       entity: "Exchange", approx: 600_000_000 },
      { address: "AC5RDfQFmDS1deWZos921JfqscXdByf8BrmHx3Ms1ZXF", label: "Coinbase",       entity: "Exchange", approx: 350_000_000 },
      { address: "CakcnaRDHka2gXyfbEd2d3xsvkJkqsLw2akB3zsN1D2S", label: "OKX",           entity: "Exchange", approx: 220_000_000 },
      { address: "FWznbcNXWQuHTawe9RxvQ2LdCENssh12dsznf4RiouN5", label: "Kraken",         entity: "Exchange", approx: 110_000_000 },
      { address: "2AQdpHJ2JpcEgPiATUXjQxA8QmafFegfQwSLWSprPicm", label: "Upbit",          entity: "Exchange", approx:  80_000_000 },
    ],
  },
  // RNDR / RENDER (Solana SPL mint)
  "rndrizKT3MK1iimdxRdWabcF7Zg7AR5T4nud4EkHBof": {
    supply: 388_989_476, unit: "RNDR",
    holders: [
      { address: "9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM", label: "Binance",       entity: "Exchange", approx: 23_339_369 },
      { address: "AC5RDfQFmDS1deWZos921JfqscXdByf8BrmHx3Ms1ZXF", label: "Coinbase",       entity: "Exchange", approx: 15_559_579 },
      { address: "CakcnaRDHka2gXyfbEd2d3xsvkJkqsLw2akB3zsN1D2S", label: "OKX",           entity: "Exchange", approx:  9_724_737 },
      { address: "FWznbcNXWQuHTawe9RxvQ2LdCENssh12dsznf4RiouN5", label: "Kraken",         entity: "Exchange", approx:  5_834_842 },
      { address: "2AQdpHJ2JpcEgPiATUXjQxA8QmafFegfQwSLWSprPicm", label: "Upbit",          entity: "Exchange", approx:  3_889_895 },
    ],
  },
  // POPCAT
  "7GCihgDB8fe6KNjn2MYtkzZcRjQy3t9GHdC8uHYmW2hr": {
    supply: 979_983_747, unit: "POPCAT",
    holders: [
      { address: "5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1", label: "Raydium Pool",  entity: "Contract", approx: 58_799_025 },
      { address: "9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM", label: "Binance",       entity: "Exchange", approx: 48_999_187 },
      { address: "AC5RDfQFmDS1deWZos921JfqscXdByf8BrmHx3Ms1ZXF", label: "Coinbase",       entity: "Exchange", approx: 29_399_512 },
      { address: "CakcnaRDHka2gXyfbEd2d3xsvkJkqsLw2akB3zsN1D2S", label: "OKX",           entity: "Exchange", approx: 14_699_756 },
    ],
  },
  // RAY (Raydium)
  "4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R": {
    supply: 555_000_000, unit: "RAY",
    holders: [
      { address: "5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1", label: "Raydium Pool",  entity: "Contract", approx: 55_500_000 },
      { address: "9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM", label: "Binance",       entity: "Exchange", approx: 27_750_000 },
      { address: "AC5RDfQFmDS1deWZos921JfqscXdByf8BrmHx3Ms1ZXF", label: "Coinbase",       entity: "Exchange", approx: 16_650_000 },
      { address: "CakcnaRDHka2gXyfbEd2d3xsvkJkqsLw2akB3zsN1D2S", label: "OKX",           entity: "Exchange", approx: 11_100_000 },
    ],
  },
  // ORCA
  "orcaEKTdK7LKz57vaAYr9QeNsVEPfiu6QeMU1kektZE": {
    supply: 100_000_000, unit: "ORCA",
    holders: [
      { address: "9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM", label: "Binance",       entity: "Exchange", approx:  8_000_000 },
      { address: "AC5RDfQFmDS1deWZos921JfqscXdByf8BrmHx3Ms1ZXF", label: "Coinbase",       entity: "Exchange", approx:  5_000_000 },
      { address: "CakcnaRDHka2gXyfbEd2d3xsvkJkqsLw2akB3zsN1D2S", label: "OKX",           entity: "Exchange", approx:  3_000_000 },
    ],
  },
};

// Helper: POST to a Solana JSON-RPC endpoint with a hard abort timeout
async function solRpc(rpcUrl, method, params, timeoutMs = 7000) {
...
// RPC endpoints tried in order (Helius prepended at runtime if key is set)
...
async function fetchSolanaHolders(mintAddress, meta = {}) {
  ...
  // ── Always fetch SOL supply + metadata from CoinGecko ─────────────────────
  ...
  // ── Build RPC list: Helius first if env key is set ─────────────────────────
  const HELIUS_KEY = process.env.HELIUS_API_KEY;
  const rpcList = HELIUS_KEY
    ? [`https://mainnet.helius-rpc.com/?api-key=${HELIUS_KEY}`, ...SOL_RPC_ENDPOINTS]
    : SOL_RPC_ENDPOINTS;

  // ── Sources 1 & 2: Live RPC — native SOL or SPL token ─────────────────────
    ...
    try {
      if (isNative) {
        ...
        holders = accounts.map(a => {
          ...
          return {
            address:    a.address,
            percentage: parseFloat(((sol / totalSupply) * 100).toFixed(4)),
      ...
      source = `Solana RPC live — ${new URL(rpcUrl).hostname}`;
      break;
    } catch (e) {
      console.warn(`[Solana RPC] ${new URL(rpcUrl).hostname}:`, e.message);
    }
  }

  // ── Source 3: Static fallback — covers native SOL + top SPL tokens ─────────
  // Fires when all RPCs fail (Vercel datacenter IPs rate-limited by public nodes).
  if (!holders.length) {
    const fallback = SOL_STATIC_FALLBACKS[mintAddress];
    if (fallback) {
      totalSupply = isNative ? circulatingSOL : fallback.supply;
      const unit  = fallback.unit || "tokens";
      holders = fallback.holders.map(w => ({
        address:    w.address,
        percentage: parseFloat(((w.approx / totalSupply) * 100).toFixed(4)),
        balance:    `${w.approx.toLocaleString()} ${unit} (approx)`,
        label:      w.label,
        entity:     w.entity,
        isContract: w.entity === "Contract",
        chain:      "solana",
      }));
      source = "Static fallback data (live RPCs rate-limited — add HELIUS_API_KEY for live data)";
      console.warn(`[Solana] Static fallback used for ${mintAddress}`);
    }
  }

  if (!holders.length)
    throw new Error(
      "Could not fetch Solana token holder data. " +
      "All public RPC endpoints are currently rate-limiting this server. " +
      "Add a free HELIUS_API_KEY from helius.dev to your Vercel environment variables to fix this."
    );
...
//
// Known coins are looked up directly via their CoinGecko ID, bypassing the
// /search call that costs an extra rate-limit token. For completely unknown
// coins both calls are made with a 1-second back-off on 429.
// ─────────────────────────────────────────────────────────────────────────────

// Common coins: ticker/name → CoinGecko ID + Solana mint (where applicable).
// Lets us skip the /search call and go straight to /coins/{id}.
const KNOWN_COIN_IDS = {
  // Solana ecosystem — resolved directly to fetchSolanaHolders
  "bonk":    { id: "bonk",              solana: "DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263" },
  "wif":     { id: "dogwifcoin",        solana: "EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLHYxdM65zcjm" },
  "dogwifhat":{ id: "dogwifcoin",       solana: "EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLHYxdM65zcjm" },
  "jup":     { id: "jupiter-exchange-solana", solana: "JUPyiwrYJFskUPiHa7hkeR8VUtAeFoSYbKedZNsDvCN" },
  "jupiter": { id: "jupiter-exchange-solana", solana: "JUPyiwrYJFskUPiHa7hkeR8VUtAeFoSYbKedZNsDvCN" },
  "pyth":    { id: "pyth-network",      solana: "HZ1JovNiVvGqswkd1ba9lJiCGHrg5rTwNKHqFqFxbQXY" },
  "render":  { id: "render-token",      solana: "rndrizKT3MK1iimdxRdWabcF7Zg7AR5T4nud4EkHBof"  },
  "rndr":    { id: "render-token",      solana: "rndrizKT3MK1iimdxRdWabcF7Zg7AR5T4nud4EkHBof"  },
  "ray":     { id: "raydium",           solana: "4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R" },
  "raydium": { id: "raydium",           solana: "4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R" },
  "orca":    { id: "orca",              solana: "orcaEKTdK7LKz57vaAYr9QeNsVEPfiu6QeMU1kektZE"  },
  "popcat":  { id: "popcat",            solana: "7GCihgDB8fe6KNjn2MYtkzZcRjQy3t9GHdC8uHYmW2hr" },
  "samo":    { id: "samoyedcoin",       solana: "7xKXtg2CW87d97TXJSDpbD5jBkheTqA83TZRuJosgAsU" },
  "mngo":    { id: "mango-markets",     solana: "MangoCzJ36AjZyKwVj3VnYU4GTonjfVEnJmvvWaxLac"  },
  "fida":    { id: "bonfida",           solana: "EchesyfXePKdLtoiZSL8pBe8Myagyy8ZRqsACNCFGnvp"  },
  // Native coins — go straight to dedicated fetchers
  "btc":     { id: "bitcoin"     }, "bitcoin":   { id: "bitcoin"     },
  "eth":     { id: "ethereum"    }, "ethereum":  { id: "ethereum"    },
  "bnb":     { id: "binancecoin" }, "binancecoin":{ id: "binancecoin" },
  "sol":     { id: "solana"      }, "solana":    { id: "solana"      },
};

// fetchJSON with one automatic retry after 1.2 s on HTTP 429
...
async function resolveByName(query) {
  ...
  // ── Fast path: known coin → skip /search, go straight to details ──────────
  const known = KNOWN_COIN_IDS[ql];
  if (known?.solana) {
    // Fetch CoinGecko metadata (price, image) gracefully — not required
    const meta = {};
    try {
      const cg = await fetchJSONWithRetry(
        `https://api.coingecko.com/api/v3/coins/${known.id}?localization=false&tickers=false&market_data=true&community_data=false&developer_data=false`
      );
      meta.name      = cg.name;
      meta.ticker    = cg.symbol?.toUpperCase();
      meta.image     = cg.image?.small || null;
      meta.price     = cg.market_data?.current_price?.usd || null;
      meta.marketCap = cg.market_data?.market_cap?.usd    || null;
    } catch { /* metadata is optional — holder data still works */ }
    return fetchSolanaHolders(known.solana, meta);
  }
  if (known) {
    // Native coin shortcut
    const id = known.id;
    if (id === "bitcoin")     return fetchBitcoinHolders();
    if (id === "ethereum")    return fetchEthereumHolders();
    if (id === "binancecoin") return fetchBNBHolders();
    if (id === "solana")      return fetchSolanaHolders(SOL_MINT);
  }

  // ── Slow path: unknown coin → CoinGecko search then details ──────────────
