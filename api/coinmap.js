...
export const COINS = [
  ...
  // ══════════════════════════════════════════════════════════════════════════
  { aliases:["cake","pancakeswap"],               cgId:"pancakeswap-token", type:"NON-EVM", contract:null, chain:null },
  { aliases:["xvs","venus"],                      cgId:"venus", type:"NON-EVM",          contract:null, chain:null },
  { aliases:["bake","bakeryswap"],                cgId:"bakerytoken", type:"NON-EVM",   contract:null, chain:null },
  { aliases:["alpaca","alpaca finance"],          cgId:"alpaca-finance", type:"NON-EVM", contract:null, chain:null },
  { aliases:["the","the tokenized equity"],       cgId:"the-tokenized-equity", type:"NON-EVM", contract:null, chain:null },
  { aliases:["raca","radio caca"],                cgId:"radio-caca", type:"NON-EVM",        contract:null, chain:null },
  { aliases:["sfp","safepal"],                    cgId:"safepal", type:"NON-EVM",           contract:null, chain:null },
  { aliases:["pancake","syrup"],                  cgId:"pancakeswap-token", type:"NON-EVM", contract:null, chain:null },
  { aliases:["vai"],                              cgId:"vai", type:"NON-EVM",               contract:null, chain:null },
  { aliases:["epx","ellipsis x"],                 cgId:"ellipsis-x", type:"NON-EVM",        contract:null, chain:null },
  { aliases:["eps","ellipsis"],                   cgId:"ellipsis", type:"NON-EVM",          contract:null, chain:null },
  { aliases:["hay","helio protocol"],             cgId:"helio-protocol", type:"NON-EVM",    contract:null, chain:null },
  { aliases:["bnbx","stader bnbx"],               cgId:"bnbx", type:"NON-EVM",              contract:null, chain:null },
  { aliases:["snbnb","synclub bnb"],              cgId:"synclub-bnb", type:"NON-EVM",       contract:null, chain:null },
  { aliases:["bscx","bscex"],                     cgId:"bscex", type:"NON-EVM",             contract:null, chain:null },
  { aliases:["bxy","bexy"],                       cgId:"bexy", type:"NON-EVM",              contract:null, chain:null },
  { aliases:["dnt","district0x"],                 cgId:"district0x", type:"NON-EVM",        contract:null, chain:null },
